...
store1 = Store.create(name: "Burnaby", annual_revenue: 300000, mens_apparel: true, womens_apparel: false);
puts "#{store1.valid?}: #{store1.errors.messages}"
Store.create(name: "Richomond", annual_revenue: 1260000, mens_apparel: false, womens_apparel: true);
